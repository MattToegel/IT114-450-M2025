...
public class HigherOrLower {
    ...
    private void run() {
        /*
         * ⚠ Important: Using try-with-resources ensures Scanner is closed
         * automatically.
         * However, since Scanner wraps System.in, closing it will close System.in
         * permanently.
        ...
        try (Scanner scanner = new Scanner(System.in)) {
            ...
            while (isRunning) {
                ...
                if (scanner.hasNext()) {
                    ...
                    // make the user's life easier (remove leading/trailing spaces, make lowercase
